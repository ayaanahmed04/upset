"""Run exploratory defensive feature-group comparisons on frozen folds."""
...
from upset.modeling.defense_groups import export_defense_groups
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, default=base / "experiments" / "defense_groups_v1"
    )
